...
class TabularClassifier:
    ...
    def __init__(self, features=None, td_file=None, td_format='tabular', test_file=None, test_format='tabular', transformer_embeddings_training=None, transformer_embeddings_test=None, normalize_columns=None, normalization='NFC'):
