...
class Tagger:
    ...
    def train_model(self,wids,tokens,tags,output_model):
        ...
        encodings = self.tokenizer(tokens, is_split_into_words=True, return_offsets_mapping=True, padding=True, truncation=True)
        ...
        with torch.no_grad():
            for idx, batch in enumerate(loader):
                ...
                for batch_idx, batch_piece in enumerate(labels):
                    for label_idx, label in enumerate(batch_piece):
                        if label != -100:
                            softmaxed_predictions = torch.nn.functional.softmax(outputs[1][batch_idx][label_idx], -1).tolist()
                            preds = {}
...
tagger = Tagger(transformer_model='C:/Users/u0111778/OneDrive - KU Leuven/Glaux/NLP/electra-grc-2',training_data='C:/Users/u0111778/Documents/ElectraTagger/tmp_test.txt',include_upos=True,include_xpos=True,model_dir='C:/Users/u0111778/Documents/ElectraTagger/models')
tagger.possible_tags = tagger.read_possible_tags('C:/Users/u0111778/Documents/ElectraTagger/PossibleTags_test.txt')
tagger.lexicon = tagger.read_lexicon('C:/Users/u0111778/Documents/ElectraTagger/Lexicon_test.txt')
tagger.add_training_data_to_lexicon()
tagger.test_reader = CONLLReader('C:/Users/u0111778/Documents/ElectraTagger/tmp_test.txt')
tagger.test_data = tagger.test_reader.parse_conll()
tagger.tokenizer = ElectraTokenizerFast.from_pretrained('C:/Users/u0111778/OneDrive - KU Leuven/Glaux/NLP/electra-grc-2', do_lower_case=False, strip_accents=False, model_max_length=512)
if mode=='train':
    ...
    tagger.tag_data(wids=wids,tokens=tokens,preds=all_preds,output_data='C:/Users/u0111778/Documents/ElectraTagger/tmp_tagged.txt')
